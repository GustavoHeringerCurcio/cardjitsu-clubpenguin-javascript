...
let playerCards = [];
let enemyPower = Math.floor(Math.random() *8 + 3);
...
cards.forEach((card, index) => {
    ...
    if(atualPoints === 3 || enemyAtualPoints === 3) {
        ...
        enemyPower =  Math.floor(Math.random() *8 + 3);
        enemyvalue.innerHTML = enemyPower
...
const elementIcons = {
    fire: "images/cards/fire-icon.png",
    water: "images/cards/water-icon.png",
    snow: "images/cards/snow-icon.png"
}
...
function setEnemyPoints(){
    enemyPoints.innerHTML += `<div class=" enemy-points-style" ><img src="images/cards/enemy-icon.png"></div>`
    enemyAtualPoints++;
}
